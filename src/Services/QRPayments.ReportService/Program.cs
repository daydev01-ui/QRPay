...
var txBaseUrl = builder.Configuration["Services:TransactionServiceUrl"] ?? "http://transaction-service:8080";
builder.Services.AddHttpClient("TransactionService", c =>
{
    c.BaseAddress = new Uri(txBaseUrl);
});
